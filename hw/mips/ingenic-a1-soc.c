 ...
 *
 * The Ingenic A1 is a MIPS32r2 XBurst2 SoC featuring DDR3 memory,
 * dual SPI flash controllers, dual Gigabit Ethernet, triple USB OTG,
 * HDMI, SATA, and hardware video encode/decode. It targets NVR and
 * smart-display applications.
 *
 * This model also serves T40 and T41 XBurst2 SoCs via the variant
 * table, mirroring how ingenic-t31-soc.c handles all XBurst1 T-series.
 *
...
/*
 * Global OST - 64-bit free-running counter at 24 MHz / prescale.
...
static const A1Variant a1_variants[] = {
    /* A1 family - CPUID 0x000A1000 area */
    { "a1n",  0x000A1000, 0x11110000, MNOD( 92,1,2,1), MNOD(134,1,2,1), 256 },
    { "a1l",  0x000A1000, 0x33330000, MNOD( 92,1,2,1), MNOD(134,1,2,1), 128 },
    { "a1x",  0x000A1000, 0x22220000, MNOD( 92,1,2,1), MNOD(117,1,2,1), 512 },
    { "a1a",  0x000A1000, 0x44440000, MNOD(100,1,2,1), MNOD(134,1,2,1), 1024 },
    { "a1nt", 0x000A1000, 0x55550000, MNOD( 92,1,2,1), MNOD(117,1,2,1), 256 },
    /* T41 family */
    { "t41nq", 0x00040000, 0xAAAA0000, MNOD( 92,1,2,1), MNOD(125,1,3,1), 256 },
    { "t41lq", 0x00040000, 0xBBBB0000, MNOD( 92,1,2,1), MNOD(125,1,3,1), 128 },
    /* T40 family */
    { "t40n",  0x00040000, 0x11110000, MNOD( 92,1,2,1), MNOD(125,1,3,1), 256 },
    { "t40xp", 0x00040000, 0x22220000, MNOD( 92,1,2,1), MNOD(125,1,3,1), 128 },
    /* Default */
    { "qemu",  0x000A1000, 0xEE000000, MNOD( 92,1,2,1), MNOD(134,1,2,1), 256 },
    { NULL, 0, 0, 0, 0, 0 }
};
