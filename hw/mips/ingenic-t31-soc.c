...
static const T31Variant t31_variants[] = {
    ...
    { "t10",   0x10005000, 0x00000000, MNOD( 71,2,1,1), MNOD(100,1,2,1),  64 },  /* 860/600 */
    { "t10l",  0x10005000, 0x00000000, MNOD( 59,2,1,1), MNOD(100,1,2,1),  64 },  /* 712/600 */
    ...
    { "t30n",  0x10030000, 0x11110000, (( 74<<20)|(1<<14)|(1<<11)|(2<<5))|PLL_ON_EN, MNOD(125,1,3,1),  64 },  /*  900/500 */
    { "t30x",  0x10030000, 0x22220000, (( 74<<20)|(1<<14)|(1<<11)|(2<<5))|PLL_ON_EN, MNOD(100,1,2,1), 128 },  /*  900/600 */
    { "t30l",  0x10030000, 0x33330000, ((124<<20)|(1<<14)|(2<<11)|(2<<5))|PLL_ON_EN, MNOD(125,1,3,1),  64 },  /*  750/500 */
    { "t30a",  0x10030000, 0x44440000, ((149<<20)|(2<<14)|(1<<11)|(1<<5))|PLL_ON_EN, MNOD(100,1,2,1), 128 },  /* 1200/600 */
    { "t30z",  0x10030000, 0x55550000, (( 74<<20)|(1<<14)|(1<<11)|(2<<5))|PLL_ON_EN, MNOD(125,1,3,1),  64 },  /*  900/500 */
    /* T23 family (cpuid bits[27:12] = 0x0023, InnoSilicon DDR PHY like T31) */
    { "t23n",  0x10023000, 0x11110000, MNOD(297,3,2,1), MNOD(100,1,2,1),  64 },  /* 1188/600 */
    { "t23x",  0x10023000, 0x22220000, MNOD(297,3,2,1), MNOD(100,1,2,1),  64 },  /* 1188/600 */
    { "t23dl", 0x10023000, 0x33330000, MNOD(297,3,2,1), MNOD(100,1,2,1),  32 },  /* 1188/600 */
    { "t23zn", 0x10023000, 0x77770000, MNOD(125,1,3,1), MNOD(125,1,3,1),  64 },  /* 1000/500 */
